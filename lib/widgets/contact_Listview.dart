      ...
      child: Row(
        children: [
          ...
          InkWell(
            ...
            // btnOkOnPress: () {
            //   try {
            //     //DatabaseProvider.db.deleteANCFromDB(widget.data.id ?? 0);
            //     helper.deleteANCFromDB(widget.data.id ?? 0);
          ...
          InkWell(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(builder: (builder)=>  EditANC(reachCollectVo: widget.data)));
            },
            child: Container(
              height: 30,
              width: 30,
